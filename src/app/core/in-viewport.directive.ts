...
import { InViewportConfig, InViewportConfigOptions } from './in-viewport/in-viewport-config';
import { InViewportService } from './in-viewport/in-viewport.service';
...
export class InViewportDirective implements AfterViewInit, OnDestroy {
 ...
 //   console.log('DinViewport___constructor', this.elementRef , this.inViewport, this.inViewportAction);
  }

  public ngAfterViewInit(): void {
 //   console.log('DinViewport___ngAfterViewInit', this.elementRef , this.inViewport);
